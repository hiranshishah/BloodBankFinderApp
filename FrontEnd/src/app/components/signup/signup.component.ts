...
export class SignupComponent implements OnInit {
  ...
  constructor(public dialogRef: MatDialogRef<SignupComponent>, public router: Router,public dialog: MatDialog, public userService: AppserviceService) { }
     ...
     if (this.registerForm.valid) {
       ...
       this.userService.addUser(userData).subscribe(
         response => {
           ...
           alert(this.registerForm.get('user_name').value + " registered Successfully.");
